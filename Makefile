...
readme:  ## Generate README.md based on GoDoc comments
	go run github.com/posener/goreadme/cmd/goreadme@master -title 'CashDrawer (cd)' -import-path 'github.com/Nimon77/cd' -badge-godoc -badge-codecov -badge-goreportcard -generated-notice -types -methods > README.md
